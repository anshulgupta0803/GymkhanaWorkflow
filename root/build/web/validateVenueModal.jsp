<%
    ...
    if (request.getParameter("validateVenueId") != null && type != null && (type == 7 || type == 5 || type == 6))
    {
%>
<script>
    $( document ).ready(function() {
        $('.validateVenueModal').modal('setting', 'transition', 'vertical flip').modal('show');
    });
</script>
<div class="ui modal validateVenueModal">
    ...
    <div class="content">
        <div>
            <%
                ...
                SQL = "SELECT * FROM `venue` JOIN `event` ON `venue`.`venue_event_id` = `event`.`event_id` WHERE venue_id = " + request.getParameter("validateVenueId");
                try
                {
            ...
            %>
                        ...
                        <a class="item">
                            ...
                            <%
                            out.print("<br/><br/>Do you want to Validate this Venue ? <br/><br/>");%><a href="validateaction.jsp?object=venue&id=<%out.print(db.rs.getInt("venue_id"));%>&decision=1" class="myButton">Yes</a> &nbsp;&nbsp;<a href="validateaction.jsp?object=venue&id=<%out.print(db.rs.getInt("venue_id"));%>&decision=0" class="myButton">No</a>
